...
class UserRepository:
    ...
    async def get_user_by_chat_id(self, session, chat_id: int):
        pass
    ...
    async def get_user_by_id(self, session, user_id: int):
        pass
    ...
    async def fill_about(self, session, user_id: int, about):
        pass
